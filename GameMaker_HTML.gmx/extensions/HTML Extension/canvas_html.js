...
function canvas_html_add(a,b,c)
{
	canvas_html=document.getElementById("canvas_html");
	canvas_element=document.createElement("div");
	canvas_html_id++;canvas_element.setAttribute("id","canvas_html_"+canvas_html_id);
...
var canvas_html_callbacks=new Array;
